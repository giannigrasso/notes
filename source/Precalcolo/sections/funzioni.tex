...
\begin{center}
    \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
        %Straight Lines [id:da4972688906474013] 
        \draw    (145,141) -- (507.67,141.67) ;
        %Straight Lines [id:da5165025017437443] 
        \draw    (145,172.33) -- (507.67,173) ;
        %Straight Lines [id:da6462703356664974] 
        \draw    (235.67,111.67) -- (235.67,203.67) ;
        %Straight Lines [id:da7072375391550509] 
        \draw    (297,113.67) -- (297,205.67) ;
        %Straight Lines [id:da39673127095920524] 
        \draw    (365.67,111.67) -- (365.67,203.67) ;
        %Straight Lines [id:da004018353124040308] 
        \draw    (437.67,112.33) -- (437.67,204.33) ;
        %Straight Lines [id:da137543410594554] 
        \draw    (507,111.67) -- (507,203.67) ;
        %Shape: Circle [id:dp5466958992796501] 
        \draw  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ] (288.67,129.67) .. controls (288.67,124.88) and (292.55,121) .. (297.33,121) .. controls (302.12,121) and (306,124.88) .. (306,129.67) .. controls (306,134.45) and (302.12,138.33) .. (297.33,138.33) .. controls (292.55,138.33) and (288.67,134.45) .. (288.67,129.67) -- cycle ;
        %Shape: Circle [id:dp5553687515232614] 
        \draw  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ] (288.67,186.33) .. controls (288.67,181.55) and (292.55,177.67) .. (297.33,177.67) .. controls (302.12,177.67) and (306,181.55) .. (306,186.33) .. controls (306,191.12) and (302.12,195) .. (297.33,195) .. controls (292.55,195) and (288.67,191.12) .. (288.67,186.33) -- cycle ;
        %Shape: Circle [id:dp3450247557739117] 
        \draw  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ] (356.67,129) .. controls (356.67,124.21) and (360.55,120.33) .. (365.33,120.33) .. controls (370.12,120.33) and (374,124.21) .. (374,129) .. controls (374,133.79) and (370.12,137.67) .. (365.33,137.67) .. controls (360.55,137.67) and (356.67,133.79) .. (356.67,129) -- cycle ;
        %Shape: Circle [id:dp3910215917269322] 
        \draw  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ] (357.33,187) .. controls (357.33,182.21) and (361.21,178.33) .. (366,178.33) .. controls (370.79,178.33) and (374.67,182.21) .. (374.67,187) .. controls (374.67,191.79) and (370.79,195.67) .. (366,195.67) .. controls (361.21,195.67) and (357.33,191.79) .. (357.33,187) -- cycle ;
        %Shape: Circle [id:dp7395101165715106] 
        \draw  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ] (429,158.33) .. controls (429,153.55) and (432.88,149.67) .. (437.67,149.67) .. controls (442.45,149.67) and (446.33,153.55) .. (446.33,158.33) .. controls (446.33,163.12) and (442.45,167) .. (437.67,167) .. controls (432.88,167) and (429,163.12) .. (429,158.33) -- cycle ;
        
        % Text Node
        \draw (148,121.07) node [anchor=north west][inner sep=0.75pt]    {$x^{2} +x-6$};
        % Text Node
        \draw (148,151.07) node [anchor=north west][inner sep=0.75pt]    {$x-4$};
        % Text Node
        \draw (148.67,184.4) node [anchor=north west][inner sep=0.75pt]    {$f( x)$};
        % Text Node
        \draw (264,119.33) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,opacity=1 ] [align=left] {+};
        % Text Node
        \draw (465.33,118.67) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,opacity=1 ] [align=left] {+};
        % Text Node
        \draw (465.33,148) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,opacity=1 ] [align=left] {+};
        % Text Node
        \draw (466,178) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,opacity=1 ] [align=left] {+};
        % Text Node
        \draw (325.33,178) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,opacity=1 ] [align=left] {+};
        % Text Node
        \draw (394.67,118) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,opacity=1 ] [align=left] {+};
        % Text Node
        \draw (327.33,117.33) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,opacity=1 ] [align=left] {\mbox{-}};
        % Text Node
        \draw (265.33,150) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,opacity=1 ] [align=left] {\mbox{-}};
        % Text Node
        \draw (266,178) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,opacity=1 ] [align=left] {\mbox{-}};
        % Text Node
        \draw (327,147.67) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,opacity=1 ] [align=left] {\mbox{-}};
        % Text Node
        \draw (397.33,146.67) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,opacity=1 ] [align=left] {\mbox{-}};
        % Text Node
        \draw (396.67,176) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,opacity=1 ] [align=left] {\mbox{-}};
        % Text Node
        \draw (221.33,93.73) node [anchor=north west][inner sep=0.75pt]    {$-\infty $};
        % Text Node
        \draw (286,96.07) node [anchor=north west][inner sep=0.75pt]    {$-3$};
        % Text Node
        \draw (360.67,94.4) node [anchor=north west][inner sep=0.75pt]    {$2$};
        % Text Node
        \draw (433.33,94.07) node [anchor=north west][inner sep=0.75pt]    {$4$};
        % Text Node
        \draw (494,95.07) node [anchor=north west][inner sep=0.75pt]    {$+\infty $};
        % Text Node
        \draw (426.67,181.33) node [anchor=north west][inner sep=0.75pt]   [align=left] {\textcolor[rgb]{0.29,0.56,0.89}{NO}};
        % Text Node
        \draw (420,201.07) node [anchor=north west][inner sep=0.75pt]    {$ \begin{array}{l}
        \textcolor[rgb]{0.82,0.01,0.11}{A.V}\\
        \textcolor[rgb]{0.82,0.01,0.11}{x=4}
        \end{array}$};
    \end{tikzpicture}        
\end{center}
...
\begin{align*}
    ...
    \Rightarrow \frac{x^2+x-6}{x-4} =& x + 5 + \frac{14}{x - 4} \\
    \Rightarrow \frac{x^2+x-6}{x-4}\simeq& x+5 \text{ per "x grande"} \\
    \Rightarrow y =& x+5 \text{ è un asintoto obliquo}
\end{align*}
...
\begin{center}
    \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
        %Shape: Axis 2D [id:dp9628673516714323] 
        \draw  (207,192.75) -- (466.5,192.75)(336.5,86.5) -- (336.5,288.25) (459.5,187.75) -- (466.5,192.75) -- (459.5,197.75) (331.5,93.5) -- (336.5,86.5) -- (341.5,93.5)  ;
        %Shape: Circle [id:dp49860882750059576] 
        \draw  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ][fill={rgb, 255:red, 74; green, 144; blue, 226 }  ,fill opacity=1 ] (333.9,144.9) .. controls (333.9,143.41) and (335.11,142.2) .. (336.6,142.2) .. controls (338.09,142.2) and (339.3,143.41) .. (339.3,144.9) .. controls (339.3,146.39) and (338.09,147.6) .. (336.6,147.6) .. controls (335.11,147.6) and (333.9,146.39) .. (333.9,144.9) -- cycle ;
        %Straight Lines [id:da7611015925511868] 
        \draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ] [dash pattern={on 0.84pt off 2.51pt}]  (380.17,51.5) -- (383.37,274.03) ;
        %Straight Lines [id:da26380129490074333] 
        \draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ] [dash pattern={on 0.84pt off 2.51pt}]  (212.17,278.83) -- (412.83,64.17) ;
        %Curve Lines [id:da8298542396571204] 
        \draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ]   (408,64.25) .. controls (405.58,68.34) and (403.34,71.69) .. (401.27,74.35) .. controls (387.9,91.51) and (381.7,80.13) .. (383,56.75) ;
        %Shape: Circle [id:dp8532295278670373] 
        \draw  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ][fill={rgb, 255:red, 74; green, 144; blue, 226 }  ,fill opacity=1 ] (306.9,192.4) .. controls (306.9,190.91) and (308.11,189.7) .. (309.6,189.7) .. controls (311.09,189.7) and (312.3,190.91) .. (312.3,192.4) .. controls (312.3,193.89) and (311.09,195.1) .. (309.6,195.1) .. controls (308.11,195.1) and (306.9,193.89) .. (306.9,192.4) -- cycle ;
        %Shape: Circle [id:dp6564685374972533] 
        \draw  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ][fill={rgb, 255:red, 74; green, 144; blue, 226 }  ,fill opacity=1 ] (348.9,192.9) .. controls (348.9,191.41) and (350.11,190.2) .. (351.6,190.2) .. controls (353.09,190.2) and (354.3,191.41) .. (354.3,192.9) .. controls (354.3,194.39) and (353.09,195.6) .. (351.6,195.6) .. controls (350.11,195.6) and (348.9,194.39) .. (348.9,192.9) -- cycle ;
        %Shape: Circle [id:dp16044472079753147] 
        \draw  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ][fill={rgb, 255:red, 74; green, 144; blue, 226 }  ,fill opacity=1 ] (334.4,178.4) .. controls (334.4,176.91) and (335.61,175.7) .. (337.1,175.7) .. controls (338.59,175.7) and (339.8,176.91) .. (339.8,178.4) .. controls (339.8,179.89) and (338.59,181.1) .. (337.1,181.1) .. controls (335.61,181.1) and (334.4,179.89) .. (334.4,178.4) -- cycle ;
        %Curve Lines [id:da7645395525174395] 
        \draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ]   (221,276.25) .. controls (241,266.25) and (291.5,208.25) .. (309.6,195.1) .. controls (327.7,181.95) and (325.7,178.55) .. (337.1,178.4) .. controls (348.5,178.25) and (343.7,179.05) .. (351.6,192.9) .. controls (359.5,206.75) and (380,256.25) .. (378.5,269.75) ;
        
        % Text Node
        \draw (315.17,80.9) node [anchor=north west][inner sep=0.75pt]    {$y$};
        % Text Node
        \draw (463.83,194.9) node [anchor=north west][inner sep=0.75pt]    {$x$};
        % Text Node
        \draw (319.5,128.4) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.29,0.56,0.89}{5}$};
        % Text Node
        \draw (303,174.4) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.29,0.56,0.89}{-3}$};
        % Text Node
        \draw (353.5,175.4) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.29,0.56,0.89}{2}$};
        % Text Node
        \draw (344,136.9) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.29,0.56,0.89}{\frac{3}{2}}$};
        % Text Node
        \draw (358,13.9) node [anchor=north west][inner sep=0.75pt]    {$ \begin{array}{l}
        \textcolor[rgb]{0.29,0.56,0.89}{A.V.}\\
        \textcolor[rgb]{0.29,0.56,0.89}{x=4}
        \end{array}$};
        % Text Node
        \draw (415.5,48.4) node [anchor=north west][inner sep=0.75pt]    {$ \begin{array}{l}
        \textcolor[rgb]{0.29,0.56,0.89}{A.O.B.}\\
        \textcolor[rgb]{0.29,0.56,0.89}{\ \ x=5}
        \end{array}$};
    \end{tikzpicture}        
\end{center}
...
\begin{center}
    \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
        %Shape: Axis 2D [id:dp09385910160781141] 
        \draw  (90.67,151) -- (305.67,151)(193.67,49.67) -- (193.67,242.33) (298.67,146) -- (305.67,151) -- (298.67,156) (188.67,56.67) -- (193.67,49.67) -- (198.67,56.67)  ;
        %Shape: Axis 2D [id:dp49593425257206025] 
        \draw  (371.33,149.67) -- (586.33,149.67)(474.33,48.33) -- (474.33,241) (579.33,144.67) -- (586.33,149.67) -- (579.33,154.67) (469.33,55.33) -- (474.33,48.33) -- (479.33,55.33)  ;
        %Straight Lines [id:da768533055502012] 
        \draw  [dash pattern={on 0.84pt off 2.51pt}]  (341,30.33) -- (339.67,260.33) ;
        %Curve Lines [id:da3623022277607626] 
        \draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (93.67,147) .. controls (115.46,148.7) and (165.23,148.61) .. (204.33,133.67) .. controls (243.44,118.73) and (254.38,90.61) .. (256.33,73) ;
        %Curve Lines [id:da07677909327361265] 
        \draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (406.33,75) .. controls (411.67,121) and (524.33,153) .. (571,145) ;
        %Shape: Circle [id:dp7061577429109663] 
        \draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (190.08,136.96) .. controls (190.08,135.14) and (191.56,133.67) .. (193.38,133.67) .. controls (195.19,133.67) and (196.67,135.14) .. (196.67,136.96) .. controls (196.67,138.78) and (195.19,140.25) .. (193.38,140.25) .. controls (191.56,140.25) and (190.08,138.78) .. (190.08,136.96) -- cycle ;
        %Shape: Circle [id:dp7157683437307595] 
        \draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (471.08,130.46) .. controls (471.08,128.64) and (472.56,127.17) .. (474.38,127.17) .. controls (476.19,127.17) and (477.67,128.64) .. (477.67,130.46) .. controls (477.67,132.28) and (476.19,133.75) .. (474.38,133.75) .. controls (472.56,133.75) and (471.08,132.28) .. (471.08,130.46) -- cycle ;
        
        % Text Node
        \draw (210,54.07) node [anchor=north west][inner sep=0.75pt]    {$a >1$};
        % Text Node
        \draw (496.67,57.4) node [anchor=north west][inner sep=0.75pt]    {$0< a< 1$};
        % Text Node
        \draw (176.5,117.9) node [anchor=north west][inner sep=0.75pt]    {$1$};
        % Text Node
        \draw (458.5,130.4) node [anchor=north west][inner sep=0.75pt]    {$1$};
        % Text Node
        \draw (248,105.4) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.29,0.56,0.89}{y\ =a^{x}}$};
        % Text Node
        \draw (489,105.9) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.29,0.56,0.89}{y\ =a}\textcolor[rgb]{0.29,0.56,0.89}{^{x}}$};
    \end{tikzpicture}    
...
\begin{center}
    \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
        %Curve Lines [id:da5269394345248811] 
        \draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (230.67,138.67) .. controls (239.12,122.25) and (277.77,82.71) .. (323.67,80.33) .. controls (368.42,78.01) and (410.83,113.81) .. (424.66,133.52) ;
        \draw [shift={(425.67,135)}, rotate = 236.77] [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
        %Curve Lines [id:da6289760537813305] 
        \draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (425,161.67) .. controls (416.33,192.33) and (387.67,219.67) .. (327,221) .. controls (269.06,222.27) and (239.7,167.61) .. (231.95,154.56) ;
        \draw [shift={(231,153)}, rotate = 57.26] [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
        
        % Text Node
        \draw (146,136.07) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.29,0.56,0.89}{\log_{a}( y) =x}$};
        % Text Node
        \draw (318,56.4) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.29,0.56,0.89}{f}$};
        % Text Node
        \draw (426.67,135.07) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.29,0.56,0.89}{y\ =\ a}\textcolor[rgb]{0.29,0.56,0.89}{^{x}}$};    
    \end{tikzpicture}
\end{center}

\paragraph{Grafico e proprietà di $\log$}
\begin{center}
    \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
        %Shape: Axis 2D [id:dp29373174489484155] 
        \draw  (90.67,151) -- (305.67,151)(193.67,49.67) -- (193.67,242.33) (298.67,146) -- (305.67,151) -- (298.67,156) (188.67,56.67) -- (193.67,49.67) -- (198.67,56.67)  ;
        %Shape: Axis 2D [id:dp20909867992676257] 
        \draw  (371.33,149.67) -- (586.33,149.67)(474.33,48.33) -- (474.33,241) (579.33,144.67) -- (586.33,149.67) -- (579.33,154.67) (469.33,55.33) -- (474.33,48.33) -- (479.33,55.33)  ;
        %Straight Lines [id:da6277810381687946] 
        \draw  [dash pattern={on 0.84pt off 2.51pt}]  (341,30.33) -- (339.67,260.33) ;
        %Curve Lines [id:da305792846475868] 
        \draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (93.67,147) .. controls (115.46,148.7) and (165.23,148.61) .. (204.33,133.67) .. controls (243.44,118.73) and (254.38,90.61) .. (256.33,73) ;
        %Curve Lines [id:da47120209020880555] 
        \draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (406.33,75) .. controls (411.67,121) and (524.33,153) .. (571,145) ;
        %Shape: Circle [id:dp7870519908442267] 
        \draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (190.08,136.96) .. controls (190.08,135.14) and (191.56,133.67) .. (193.38,133.67) .. controls (195.19,133.67) and (196.67,135.14) .. (196.67,136.96) .. controls (196.67,138.78) and (195.19,140.25) .. (193.38,140.25) .. controls (191.56,140.25) and (190.08,138.78) .. (190.08,136.96) -- cycle ;
        %Shape: Circle [id:dp1209950783804572] 
        \draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (471.08,130.46) .. controls (471.08,128.64) and (472.56,127.17) .. (474.38,127.17) .. controls (476.19,127.17) and (477.67,128.64) .. (477.67,130.46) .. controls (477.67,132.28) and (476.19,133.75) .. (474.38,133.75) .. controls (472.56,133.75) and (471.08,132.28) .. (471.08,130.46) -- cycle ;
        %Straight Lines [id:da31977971077945866] 
        \draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ] [dash pattern={on 0.84pt off 2.51pt}]  (308,79.25) -- (90,219.25) ;
        %Straight Lines [id:da25396926451135526] 
        \draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ] [dash pattern={on 0.84pt off 2.51pt}]  (586.5,71.25) -- (372,220.25) ;
        %Curve Lines [id:da5902341375682384] 
        \draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ]   (197.5,238.75) .. controls (198.47,223.54) and (201.22,164.56) .. (222.5,143.25) .. controls (243.78,121.94) and (287,127.25) .. (306,130.25) ;
        %Curve Lines [id:da08257083289990397] 
        \draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ]   (479.5,63.25) .. controls (477,75.75) and (479.5,108.75) .. (492.5,135.75) .. controls (505.5,162.75) and (545.96,199.23) .. (575.5,209.25) ;
        ...
        \draw (458.5,130.4) node [anchor=north west][inner sep=0.75pt]    {$1$};
        % Text Node
        \draw (263.33,57.4) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.29,0.56,0.89}{y\ =a}\textcolor[rgb]{0.29,0.56,0.89}{^{x}}$};
        % Text Node
        \draw (382.33,56.57) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.29,0.56,0.89}{y\ =a}\textcolor[rgb]{0.29,0.56,0.89}{^{x}}$};
        % Text Node
        \draw (94,213.9) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.29,0.56,0.89}{y=\ x}$};
        % Text Node
        \draw (380.5,211.9) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.29,0.56,0.89}{y=\ x}$};
        % Text Node
        \draw (207,179.4) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.82,0.01,0.11}{y=log_{a}( x)}$};
        % Text Node
        \draw (480,200.9) node [anchor=north west][inner sep=0.75pt]    {$\textcolor[rgb]{0.82,0.01,0.11}{y=log}\textcolor[rgb]{0.82,0.01,0.11}{_{a}}\textcolor[rgb]{0.82,0.01,0.11}{(}\textcolor[rgb]{0.82,0.01,0.11}{x}\textcolor[rgb]{0.82,0.01,0.11}{)}$};    
    \end{tikzpicture}        
\end{center}
...
\begin{align*}
    D(\log_a) =& ] 0; + \infty [ \\
    Im(\log_a) =& \mathbb{R} \\
    \log_a(1) =& 0 \phantom{--} a^0 = 1 \\
    \Rightarrow& \text{zero: } (1;0) \\
    0 \in D(\log_a)\Rightarrow& \phantom{--}\text{Nessuna ordinata all'origine} \\
    x =& 0 \text{ (asse $y$) è un A.V (destro)}
\end{align*}

Ricordiamo che 
\begin{align*}
    \log_a(x) =& y \Leftrightarrow a^y = x, a> 0, a \neq 1 \\
    x >& 0 \\
    y \in& \mathbb{R}
\end{align*}
